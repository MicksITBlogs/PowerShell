...
Function DeclareGlobalVariables {
	...
	$Global:LogFile = $Env:windir+"\Logs\BuildLogs\TPM_BIOSPassword.log"
	$Global:Phase = "Final Build"
	$Global:Sequence = ""
	$Global:Title = "TPM Enable BIOS Password"
}
...
ProcessLogFile
#Disable BIOS Password and TPM
CCTKSetting "Disable BIOS Password" "valsetuppwd" "<Password> --setuppwd=" ""
#Enable BIOS Password
CCTKSetting "BIOS Password" "setuppwd" "<Password>" ""
ProcessLogFile
