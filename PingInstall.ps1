<#
	.SYNOPSIS
		Install Ping Automated Timekeeping for Lawyers
	
	.DESCRIPTION
		This script will kill all Office and Ping applications, Uninstall old versions of Ping, and then install the new version.
